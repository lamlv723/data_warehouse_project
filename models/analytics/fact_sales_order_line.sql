...
SELECT
  ...
  , COALESCE ( fact_header.customer_key, -1 ) AS customer_key -- Handiling null due to LEFT JOIN. Lesson 0110d
  , COALESCE ( fact_header.picked_by_person_key, -1 ) AS picked_by_person_key -- Handiling null due to LEFT JOIN
